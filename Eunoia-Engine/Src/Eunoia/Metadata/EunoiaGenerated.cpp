...
namespace Eunoia {
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < EunoiaWorldFlag_T > () { return 29; }

	template<>
	MetadataInfo Metadata::ConstructMetadataInfo< EunoiaWorldFlag_T >()
	{
		MetadataInfo info;
		info.id = 29;
		info.type = METADATA_ENUM;
		info.enm = Eunoia::Metadata::AllocateEnum( true );
		info.enm->name = "EunoiaWorldFlag_T";
		info.enm->values.SetCapacityAndElementCount( 7 );
		info.enm->values[ 0 ].name = "EUNOIA_WORLD_FLAG_RENDER_2D";
		info.enm->values[ 0 ].value = EUNOIA_WORLD_FLAG_RENDER_2D;
		info.enm->values[ 1 ].name = "EUNOIA_WORLD_FLAG_RENDER_3D";
		info.enm->values[ 1 ].value = EUNOIA_WORLD_FLAG_RENDER_3D;
		info.enm->values[ 2 ].name = "EUNOIA_WORLD_FLAG_DISPLAY";
		info.enm->values[ 2 ].value = EUNOIA_WORLD_FLAG_DISPLAY;
		info.enm->values[ 3 ].name = "EUNOIA_WORLD_FLAG_PHYSICS_ENGINE_3D";
		info.enm->values[ 3 ].value = EUNOIA_WORLD_FLAG_PHYSICS_ENGINE_3D;
		info.enm->values[ 4 ].name = "EUNOIA_WORLD_FLAG_RENDER";
		info.enm->values[ 4 ].value = EUNOIA_WORLD_FLAG_RENDER;
		info.enm->values[ 5 ].name = "EUNOIA_WORLD_FLAG_RENDER_DISPLAY";
		info.enm->values[ 5 ].value = EUNOIA_WORLD_FLAG_RENDER_DISPLAY;
		info.enm->values[ 6 ].name = "EUNOIA_WORLD_FLAG_ALL";
		info.enm->values[ 6 ].value = EUNOIA_WORLD_FLAG_ALL;

		return info;
	}

	template<>
	EU_API metadata_typeid Metadata::GetTypeID < EunoiaWorld > () { return 30; }

	template<>
	MetadataInfo Metadata::ConstructMetadataInfo< EunoiaWorld >()
	{
		MetadataInfo info;
		info.id = 30;
		info.type = METADATA_ENUM;
		info.enm = Eunoia::Metadata::AllocateEnum( true );
		info.enm->name = "EunoiaWorld";
		info.enm->values.SetCapacityAndElementCount( 6 );
		info.enm->values[ 0 ].name = "EUNOIA_WORLD_0";
		info.enm->values[ 0 ].value = EUNOIA_WORLD_0;
		info.enm->values[ 1 ].name = "EUNOIA_WORLD_1";
		info.enm->values[ 1 ].value = EUNOIA_WORLD_1;
		info.enm->values[ 2 ].name = "EUNOIA_WORLD_2";
		info.enm->values[ 2 ].value = EUNOIA_WORLD_2;
		info.enm->values[ 3 ].name = "MAX_EUNOIA_WORLDS";
		info.enm->values[ 3 ].value = MAX_EUNOIA_WORLDS;
		info.enm->values[ 4 ].name = "EUNOIA_WORLD_INVALID";
		info.enm->values[ 4 ].value = EUNOIA_WORLD_INVALID;
		info.enm->values[ 5 ].name = "EUNOIA_WORLD_MAIN";
		info.enm->values[ 5 ].value = EUNOIA_WORLD_MAIN;

		return info;
	}

	template<>
	EU_API metadata_typeid Metadata::GetTypeID < ECSComponent > () { return 31; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < ECSEvent > () { return 32; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < ECSSystem > () { return 33; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < CameraComponent > () { return 34; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < KeyboardMovement3DComponent > () { return 35; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < MaterialComponent > () { return 36; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < ModelComponent > () { return 37; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < MouseLookAround3DComponent > () { return 38; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < Transform3DComponent > () { return 39; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < Light3DComponent > () { return 40; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < Transform2DComponent > () { return 41; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < SpriteComponent > () { return 42; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < SpriteGroupComponent > () { return 43; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < GuiClickResponseComponent > () { return 44; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < GuiComponent > () { return 45; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < Text2DComponent > () { return 46; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < ModelAnimationComponent > () { return 47; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < KeyboardMovement2DComponent > () { return 48; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < RigidBodyShapeType > () { return 49; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < RigidBody > () { return 50; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < RigidBodyComponent > () { return 51; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < Gamepad3DComponent > () { return 52; }
	...
	template<>
	EU_API metadata_typeid Metadata::GetTypeID < KeyboardLookAround3DComponent > () { return 53; }
	...
	void Metadata::InitMetadataInfos()
	{
		...
		RegisterMetadataInfo( ConstructMetadataInfo< EunoiaWorldFlag_T >() );
		RegisterMetadataInfo( ConstructMetadataInfo< EunoiaWorld >() );
